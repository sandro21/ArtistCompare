...
import RiaaCertifications from './RiaaCertifications';
import Charts from './Charts';
import Awards from './Awards';
import GlareHover from '../blocks/Animations/GlareHover/GlareHover';
import SearchBar from './SearchBar';
import Description from './Description';
import StickyArtistImages from './StickyArtistImages';
import SEOContent from './SEOContent';
import InternalLinking from './InternalLinking';
import AdvancedSchema from './AdvancedSchema';
import SocialOptimization from './SocialOptimization';
...
function PageContent() {
  ...
  }, [searchParams, pair, handleBattleClick]);
